...
研究室運営に関わる業務を1つにまとめた Web アプリケーション（研究室統合プラットフォーム）。
...
実装済み機能の動作仕様は **[機能仕様書](docs/04_実装/機能仕様書_研究室統合プラットフォーム.md)**、
起動・構築手順は **[起動手順書](docs/04_実装/起動手順書_研究室統合プラットフォーム.md)**、
管理サイトの操作は **[管理サイト操作手順書](docs/04_実装/管理サイト操作手順書_研究室統合プラットフォーム.md)** にまとめてある。
